...
Config.ExcludeAccountsList = {"black money"} -- List of accounts names to exclude from inventory
Config.OpenControl = 167 -- Key for opening inventory. Edit html/js/config.js to change key for closing it.
